				...
				<CardHeader>
					<div className="flex items-center justify-between">
						<div>
							...
							<CardDescription>
								Test your app without Apple DeviceCheck validation by using a
								test key header.
							</CardDescription>
						</div>
						<a
						...
						>
							...
							<AccordionContent className="px-3 pb-3">
								...
								<p className="text-sm text-muted-foreground mb-2">
									...
									header to authenticate requests without implementing
									DeviceCheck in your app.
								</p>
									...
									<TooltipProvider>
										<Tooltip>
											...
											<TooltipContent side="right" className="max-w-[240px]">
												Include this key in the x-proxed-test-key header to
												bypass DeviceCheck in test environments
											</TooltipContent>
										</Tooltip>
									</TooltipProvider>
								</div>
							...
							{canOpenTestSheet ? (
								...
								<TooltipProvider>
									<Tooltip>
										...
										<TooltipContent>
											<p>
												Test Mode must be enabled and a test key must exist.
											</p>
										</TooltipContent>
									</Tooltip>
								</TooltipProvider>
								...
								>
									...
									<AccordionContent className="px-3 pb-3 text-xs">
										...
										<ul className="text-muted-foreground list-disc pl-4 space-y-0.5">
											...
											<li>
												Store test keys securely in your development
												environments
											</li>
											<li>
