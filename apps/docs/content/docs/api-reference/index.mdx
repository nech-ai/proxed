...
All API endpoints (except for `/health`) require authentication. Please refer to our [API Authentication guide](/authentication) for detailed information on how to authenticate your requests.
