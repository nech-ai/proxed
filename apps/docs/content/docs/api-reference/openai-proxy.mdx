...
Proxed exposes OpenAI model list endpoints for SDK discovery and tooling. These are **public** and do not require authentication:

*   `GET /v1/openai/models`
*   `GET /v1/openai/{projectId}/models`

These endpoints return the models currently supported by Proxed (not a live upstream pass-through), along with display name and pricing metadata.
