...
2. DeviceCheck enabled for your **App ID** + a DeviceCheck **private key** (`.p8`), **Key ID** and **Team ID** (see [Apple DeviceCheck guide](/device-check)).
...
• Use [structured responses](/structured-responses) to get type-safe JSON back.
