        ...
        <div className="border p-8 backdrop-blur">
          ...
          <div className="mb-8">
            <p>
              ...
              uses cookies and similar technologies on the proxed.ai website
              (the "Website") to improve user experience, analyse traffic, and
              provide relevant content. This Cookie Policy explains what cookies
              are, how and why we use them, and how you can manage your
              preferences.
            </p>
          </div>
          ...
          <ul>
            <li>
              ...
              for the Website to function properly. Without these cookies, some
              parts of the Website may not work as intended.
            </li>
            <li>
              <strong>Performance & Analytics Cookies:</strong> These cookies
              collect information about how visitors use the Website, such as
              which pages are visited most often. We use this information to
              improve the Website's performance and user experience.
            </li>
            <li>
              <strong>Functionality Cookies:</strong> These enable the Website
              to remember choices you make (e.g., your preferred language) and
              provide enhanced, more personalised features.
            </li>
          </ul>
          ...
          <p>
            ...
            responsible for the cookies they set on our site and will have their
            own privacy and cookie policies, which we encourage you to read.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              or advertising cookies set by third parties, you may opt out by
              following the instructions provided in their respective privacy or
              cookie policies.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            accordingly. By continuing to use the Website after these changes
