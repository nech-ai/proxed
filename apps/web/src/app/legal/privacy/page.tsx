				...
				<div className="border p-8 backdrop-blur">
					...
					<div className="mb-8">
						<p>
							...
							data we process when you join the Proxed.ai (the "Proxed.ai").
							This Privacy Policy explains how we collect, use, store, and
							protect your personal data, as well as your rights regarding that
							data.
						</p>
					</div>
					...
					<ul>
						...
						<li>
							Optional Data: Any additional information you choose to provide
							(e.g., job title, industry).
						</li>
					</ul>
					...
					<ul>
						<li>
							<strong>Product Improvement:</strong> To understand interest in
							our product and to improve features, functionalities, and user
							experience based on aggregated and anonymised feedback.
						</li>
						<li>
					...
					<ul>
						<li>
							<strong>Consent:</strong> When you provide your information to
							join the Proxed.ai, you consent to our collection and processing
							of your personal data for the purposes described.
						</li>
						<li>
							<strong>Legitimate Interests:</strong> We may process your data
							for our legitimate interests, such as improving the product and
							communicating updates, provided these interests are not overridden
					...
					<ul>
						<li>
							...
							assist us in operating our website, running the Proxed.ai, or
							providing related services, under strict confidentiality and data
					...
					<p>
						If we transfer your personal data outside of the United Kingdom or
						the European Economic Area, we will ensure appropriate safeguards
						are in place, such as Standard Contractual Clauses or an adequacy
						decision, to protect your personal data in accordance with
						applicable laws.
					</p>
					...
					<p>
						...
						purposes described in this Privacy Policy, or as required by law. If
						you request removal from the Proxed.ai, we will delete or anonymise
						your data as soon as practicable, unless legal obligations require
						us to retain it.
					</p>
					...
					<ul>
						...
						<li>
							Rectification: Ask us to correct any inaccurate or incomplete
							data.
						</li>
						<li>
						...
						<li>
							Restriction: Ask us to restrict the processing of your data in
							certain situations.
						</li>
						<li>
							Objection: Object to our processing of your data based on
						...
						<li>
							Withdraw Consent: Where we rely on consent, you may withdraw it at
					...
					<p>
						...
						destruction, or alteration. These measures are regularly reviewed
						and updated as necessary.
					</p>

					<h2>9. Children's Privacy</h2>
					<p>
						The Proxed.ai is not intended for individuals under the age of 18.
						We do not knowingly collect personal data from children. If you
						believe we have collected such data, please contact us so we can
						remove it.
					</p>
					...
					<p>
						...
						accordingly. By continuing to remain on the Proxed.ai after changes
						are made, you acknowledge and agree to the updated Policy.
					</p>
