...
export const metadata = generateMetadata({
	...
	description: "Terms & Conditions for the Proxed.ai",
	path: "/legal/terms",
	noIndex: true,
});
		...
		<div className="flex justify-center py-12">
			<Section id="about">
				<div className="border p-8 backdrop-blur">
					...
					<p>
						The Proxed.ai provides an opportunity for individuals and
						organisations to register their interest in accessing the beta
						version of Proxed.ai (the "Service"). Joining the Proxed.ai does not
						guarantee access to the beta, nor does it create any obligation on
						our part to provide access at any time.
					</p>

					<h2>3. Changes and Modifications</h2>
					<p>
						We may update, modify, or discontinue any aspect of the Proxed.ai,
						these Terms, or the Service at our sole discretion, at any time, and
						without prior notice. Such changes will be posted on our website. By
						continuing to remain on the Proxed.ai or by accessing the Service
						after changes are made, you agree to be bound by the revised Terms.
					</p>

					<h2>4. Eligibility</h2>
					<p>
						Participation in the Proxed.ai is open to individuals aged 18 and
						above, and to organisations that are duly authorised to enter into
						these Terms. By joining, you represent and warrant that you meet
						these eligibility requirements.
					</p>

					<h2>5. Use of Personal Data</h2>
					<p>
						We will collect and process certain personal data in connection with
						the Proxed.ai. Any personal data submitted will be handled in
						accordance with our Privacy Policy. By joining the Proxed.ai, you
						consent to our collection and use of this data as described therein.
					</p>
					...
					<p>
						...
						graphics, and any other material, remain the property of Comonad
						Limited and/or its licensors. Your participation in the Proxed.ai
						does not grant you any licence, right, or interest in our
					...
					<p>
						...
						fullest extent permissible by law, we disclaim all warranties,
					...
					<p>
						...
						connection with your participation in the Proxed.ai or use of the
					...
					<h2>9. Termination</h2>
					<p>
						We may remove you from the Proxed.ai at any time, for any reason, or
						for no reason, without liability. You may also request to be removed
						from the Proxed.ai at any time.
					</p>
